...
fs_node_t *initrd_dev; 	 	 	 	 	/* We also add a directory node for /dev, wo we can mount devfs later on. */
...
{
	/* Initialise the main and file header pointers and populate the
	 * the root directory.
	 */
	...
	for (i = 0; i < initrd_header->nfiles; i++)
	{
		 ...
		 * relative to the start of ramdisk. 
